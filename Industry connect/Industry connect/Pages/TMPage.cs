...
namespace September2022.Pages
{
    public class TMPage
    {
        public void CreateTM(IWebDriver driver)
        {
            ...
            codeTextbox.SendKeys("Yoza");

            // Enter description into the Description textbox
            IWebElement descriptionTextbox = driver.FindElement(By.Id("Description"));
            descriptionTextbox.SendKeys("Black_power");
            ...
            Assert.That(newCode.Text == "Yoza", "New code and expected code do not match.");
            Assert.That(newDescription.Text == "Yoza", "New description and expected description do not match.");
            Assert.That(newPrice.Text == "$30.00", "New price and expected price do not match.");
        ...
        public void EditTM(IWebDriver driver)
        {
            ...
            if (findRecordCreated.Text == "Yoza")
            {
        ...
        public void DeleteTM(IWebDriver driver)
        {
            ...
            if (findEditedRecord.Text == "Victus")
            {
